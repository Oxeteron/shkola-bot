...
russian_grades = {
    "Абрамчик Андрей": [6, 7, 9, 6, 5],
    "Башура Тимофей": [4, 4, 4, 5, 3, 4],
    "Богдан Милана": [7, 9, 8, 8, 8, 8],
    "Бородько Артём": [8, 8, 8, 7, 7, 7, 6, 8],
    "Бурблис Анастасия": [7, 8, 8, 8, 6, 5, 7, 6],
    "Ватыль Полина": [8, 6, 7, 9, 6, 7, 8, 9],
    "Гончаревич Владислав": [10, 8, 8, 8, 9, 8, 8, 9, 8, 10],
    "Грицук Илья": [7, 7, 4, 8, 4, 4, 4, 7],
    "Грохольская Мила": [5, 8, 7, 6, 7, 8, 8, 7],
    "Жешко Егор": [10, 9, 8, 9, 9, 8, 9, 9, 8, 10],
    "Кравчук Милана": [10, 9, 9, 9, 6, 8, 10, 9, 9, 10],
    "Кривошей Константин": [5, 9, 7, 6, 7, 4, 8, 6, 5],
    "Кухта Арсений": [4, 6, 7, 6, 5, 4, 6],
    "Литвин Полина": [6, 7, 7, 7, 5, 8, 8, 7],
    "Лукашенко Арина": [5, 6, 5, 6, 6, 7, 6],
    "Максимчик Матвей": [7, 9, 7, 8, 8, 7, 8, 6, 9],
    "Мысливец Роман": [7, 6, 8, 7, 8, 8, 6, 9, 9, 8],
    "Назаренко Давид": [7, 7, 8, 7, 7, 8, 7, 8],
    "Ольховик Глеб": [6, 6, 7, 7, 6, 6, 8, 5],
    "Павлюковский Артём": [4, 3, 4, 5, 4, 5, 4, 6],
    "Райдюк Александр": [7, 8, 7, 8, 8, 8],
    "Русак Дарина": [8, 8, 9, 9, 8, 9, 8, 8, 8],
    "Рябов Алексей": [4, 3, 4, 4, 4, 7, 5],
    "Савоневич Арина": [10, 9, 9, 9, 9, 8, 9, 10, 10, 9],
    "Тесловский Артём": [5, 4, 4, 4, 4, 5, 6],
    "Трипутько Михаил": [6, 8, 9, 4, 7, 8, 8, 8, 9],
    "Цуприк Артур": [6, 8, 8, 8, 7, 7, 7, 4, 8],
    "Чепко Арина": [6, 8, 5, 7, 5, 8, 8],
    "Чиж София": [6, 8, 8, 8, 6, 9, 9, 9, 9],
    "Юрса Давид": [4, 8, 7, 6, 5, 6],
    "Ясюлевич Алина": [6, 7, 7, 5, 5, 7, 7, 8]
}
...
# Инициализация: добавляем русский язык в общее хранилище
for student, marks in russian_grades.items():
    grades[f"{student}_Русский язык"] = marks
...
if __name__ == "__main__":
    print("✅ Бот запущен. Русский язык уже заполнен.")
    while True:
        try:
